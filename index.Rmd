...
Because the amount of data is very large and we didn’t find a dependency of ReportID with ReportDeliveryTime, we chose a single type of report “ReportID=93”, which is roughly 1/10 of the overall dataset as a representative subset and used it for the remaining analysis.
...
```{r Obj1 Forward Selection, cache=TRUE, echo=FALSE, warning=FALSE}
...
Sequential Repitition selected coefficients:
```{r Obj1 Seq Rep Selection, cache=TRUE, echo=FALSE, warning=FALSE}
