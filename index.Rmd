...
* GroupFI - Fully Insured Clients
* GroupSF - Self Funded Clients
* Agents - Number of agents report is ran for
* CurrencyCode - Collection of different lines of business
* GroupCount - number of client records searched by report
...
* RenderStartDateTime - when server began work on queued report(s) in queueID
...
* RenderEndDateTime - when server completed work on queued report(s) queueID
