...
reports$CurrencyCodeGroups <- sapply(reports$CurrencyCode, function(x) getCCgroups(x))
...
reports$GroupCount <- ifelse(reports$CurrencyCodeGroups>0, min(reports$CurrencyCodeGroups, reports$GroupCount),reports$GroupCount)
